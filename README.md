...
- **[SPVCNN](https://github.com/mit-han-lab/spvnas)** model for semantic segmentation from Zhijian Liu _et al_:[Searching Efficient 3D Architectures with Sparse Point-Voxel Convolution](https://arxiv.org/abs/2007.16100)
